...
import { MapPin, UserCircle, ChevronDown, ShoppingCart, LogOut, LayoutDashboard, User, X } from 'lucide-react';
    ...
    <div className='nav px-2 md:px-10 lg:px-20 border-b border-black/5 shadow-sm bg-gradient-to-b from-[#2ea9ed]/20 via-[#a8dbf7]/10 to-white relative z-50'>
      ...
      <div className="w-full pb-2 flex items-center justify-between gap-3 sm:gap-6 mt-1">
        <form onSubmit={handleSearchSubmit} className="flex-grow max-w-2xl relative">
          <input 
            className='w-full border border-gray-300 rounded-full px-4 pr-10 text-xs md:text-sm py-2 bg-white/80 focus:bg-white focus:border-blue-500 shadow-sm focus:ring-2 focus:ring-blue-100 transition-all outline-none' 
            type="search" 
